...
class Generated {
  ...
  isGeneratedGo() {
    ...
    return this.lines.slice(0, 40).some((line) => {
  ...
  isGeneratedProtocolBufferFromGo() {
    ...
    return this.lines.slice(0, 20).some((line) => {
      return line.includes("This file was autogenerated by go-to-protobuf")
    });
  }
  ...
  isGeneratedProtocolBuffer() {
    ...
    return this.lines.slice(0, 3).some((line) => {
      return line.includes("Generated by the protocol buffer compiler.  DO NOT EDIT!")
    })
  }
  ...
  isGeneratedApacheThrift() {
    ...
    return this.lines.slice(0, 6).some((line) => {
      return line.includes("Autogenerated by Thrift Compiler")
    })
  }
  ...
  isGeneratedGimp() {
    ...
    return /\/\* GIMP [\x20\x2D0-9A-Za-z]+ C-Source image dump \((?:[\uD800-\uDBFF][\uDC00-\uDFFF]|[^\n\uD800-\uDFFF])+?\.c\) \*\//.test(this.lines[0]) ||
      /\/\*  GIMP header image file format \([\x20\x2D0-9A-Za-z]+\): (?:[\uD800-\uDBFF][\uDC00-\uDFFF]|[^\n\uD800-\uDFFF])+?\.h  \*\//.test(this.lines[0])
  }
  ...
  isGeneratedVisualStudio6() {
    ...
    return this.lines.slice(0, 3).some(line => {
      return line.includes("# Microsoft Developer Studio Generated Build File")
    })
  }
  ...
  isGeneratedHaxe() {
    ...
    return this.lines.slice(0, 3).some(line => {
      return line.includes("Generated by Haxe")
    })
  }
  ...
  isGeneratedHTML() {
    ...
    // Pkgdown
    if (this.lines.slice(0, 2).some(line => {
      return /<!-- Generated by pkgdown: do not edit by hand -->/.test(line)
    })) return true
    ...
    // Doxygen
    return this.lines.slice(0, 30).some(line => {
      // console.log(line)
      // console.log(/<!--\s+Generated by Doxygen\s+[.0-9]+\s*-->/i.test(line))
      return /<!--\s+Generated by Doxygen\s+[.0-9]+\s*-->/i.test(line)
    })
  }
  ...
  isGeneratedJooq() {
    ...
    return this.lines.slice(0, 2).some(line => {
      return line.includes("This file is generated by jOOQ")
    })
  }
